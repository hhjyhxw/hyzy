/**    
 * @package com.hyzyframework.utils 
 * @description : 工具类 - 公用 
 ...
 * @create : 2011-7-13 下午03:50:48  
 * @Copyright: hyzy Corporation 2014    
 * 
 * Modification History:
 * 	Date			Author			Version			Description
 *--------------------------------------------------------------
 *2011-7-13 下午03:50:48
 */
public class CommonUtil {
	 ...
	 * @return
	 */
	public static Long[] toLongs(String[] args){
		Long[] ls = null;
		try {
			if(null!=args && args.length>0){
				
				ls = new Long[args.length];
				for(int i =0 ;i<args.length;i++){
					ls[i]=Long.parseLong(args[i]);
				}
			}
